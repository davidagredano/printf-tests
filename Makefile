...
LIB_SRCS = $(addprefix $(LIB_DIR), ft_printf.c ft_print_s.c ft_print_p.c \
           ft_print_di.c ft_print_uint.c)
...
LIB_SRCS_BONUS = $(addprefix $(LIB_DIR), ft_printf_bonus.c ft_print_c_bonus.c \
                 ...
                 ft_print_u_bonus.c ft_print_x_bonus.c ft_spec_parser.c \
...
SRCS_BONUS = main_bonus.c utils.c ft_print_c_tests.c ft_print_s_tests.c \
             ...
             ft_print_di_bonus_tests.c ft_print_u_bonus_tests.c \
